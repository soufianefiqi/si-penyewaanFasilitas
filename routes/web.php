...
Route::get('form_sewa', [App\Http\Controllers\SewaController::class,'create']);
Route::post('form_sewa', [App\Http\Controllers\SewaController::class,'store'])->name('form_sewa');
